...
namespace TestSokker
{
    [TestClass]
    public class UnitTest1
    {
        SockCounter p = new SockCounter();
        Candleblower b = new Candleblower();

        [TestMethod]
        public void SockMerchantTest1()
        {
            int[] arr = { 10, 10, 20, 20, 30, 30, 40, 40, 50 };
            Assert.AreEqual(4, p.SockPairs(arr));
        }
        ...
        public void SockMerchantTest3()
        {
            ...
            Assert.AreEqual(9, p.SockPairs(arr));
        }
