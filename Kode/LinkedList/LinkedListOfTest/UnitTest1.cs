...
namespace LinkedListOfTest
{
	...
	public class UnitTest2
	{
		...
		{
			LinkedListOfT.LinkedList<ClubMember> list = new LinkedListOfT.LinkedList<ClubMember>();
		...
		{
			// ** int list test *********
			LinkedListOfT.LinkedList<int> listInt = new LinkedListOfT.LinkedList<int>();
		...
		{
			// ** string list test **********
			LinkedListOfT.LinkedList<string> listString = new LinkedListOfT.LinkedList<string>();
		...
		{
			// ** decimal list test ***********
			LinkedListOfT.LinkedList<decimal> listDecimal = new LinkedListOfT.LinkedList<decimal>();
